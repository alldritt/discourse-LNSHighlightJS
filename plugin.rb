...
#   end
    ...
    def self.bundle(langs)
	  ...
	  #
	  matchCode = "return{"
	  newCode = "if(e==\"applescript\"){L=\"<p><strong><a class=\\\"hljs-title no-track-link\\\" onclick=\\\"window.open('sdapplescript://com.apple.scriptdebugger?action=new&script=\"+encodeURIComponent(t).replace(\"'\",\"%27\").replace(\"\\\"\",\"%22\")+\"','_self');return 0;\\\">Open in Script Debugger</a></strong></p>\"+L;}"
